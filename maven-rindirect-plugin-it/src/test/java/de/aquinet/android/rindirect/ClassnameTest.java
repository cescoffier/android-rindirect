...
public class ClassnameTest {
    ...
    public static final File ROOT = new File("target/test-classes/classname");
    ...
    @Test
    public void testClassname() throws VerificationException, FileNotFoundException, IOException {
