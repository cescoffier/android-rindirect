...
public class PomTest {
    ...
    public static final File ROOT = new File("target/test-classes/pom");
    ...
    public void setUp() throws VerificationException, IOException {
        ...
        verifier.deleteArtifact( Constants.TEST_GROUP_ID, Constants.TEST_ARTIFACT_ID, Constants.TEST_VERSION, "pom" );
