...
Let's take an application A containing an activity MyActivity.java. This application declares the package {{foo.a}}, and so, the build generates a {{foo.a.R.java}} file. Our activity depends on this R file to access resources. 
...
* Generating a {{foo.a.R.java}} file delegating on {{foo.b.r.java}} : it's the rindirect way
